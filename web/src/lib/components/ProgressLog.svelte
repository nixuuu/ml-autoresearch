...
<style>
  ...
  .log-row { display: grid; grid-template-columns: 78px 1fr; gap: 13px; padding: 9px 7px; border-bottom: 1px solid rgba(157,190,178,.08); border-radius: 7px; font-size: 11px; line-height: 1.45; animation: log-enter .32s var(--ease-out) both; }
